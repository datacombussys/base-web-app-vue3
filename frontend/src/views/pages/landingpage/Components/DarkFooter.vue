...
// icons
import { InstagramOutlined, TwitterOutlined, GooglePlusOutlined } from '@ant-design/icons-vue';
...
<template>
  <v-footer class="bg-dark text-white py-md-16 py-8 flex-column main-footer">
    <v-row>
      <v-col cols="12">
        <v-container>
          <v-row>
